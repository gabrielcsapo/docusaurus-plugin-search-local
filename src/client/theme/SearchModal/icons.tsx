...
export function IconHeading(): React.ReactElement {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20">
      <path
...
export function IconContent(): React.ReactElement {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20">
      <path
...
export function IconAction(): React.ReactElement {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20">
      <g
        stroke="currentColor"
...
export function IconNoResults(): React.ReactElement {
  return (
    <svg
      width="40"
      height="40"
...
export function IconTreeInter(): React.ReactElement {
  return (
...
export function IconTreeLast(): React.ReactElement {
  return (
    <svg viewBox="0 0 24 54">
      <g
        stroke="currentColor"
